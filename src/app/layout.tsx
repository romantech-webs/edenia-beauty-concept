  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="edenia-beauty-concept";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="EDENIA Beauty Concept."
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="edenia-beauty-concept"
          data-primary-color="#b7a597"
          defer
        ></script>
      </head>
